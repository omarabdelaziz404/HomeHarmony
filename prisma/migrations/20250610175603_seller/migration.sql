-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('user', 'seller', 'designer');
...
-- AddForeignKey
ALTER TABLE "Review" ADD CONSTRAINT "Review_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("item_id") ON DELETE CASCADE ON UPDATE CASCADE;
